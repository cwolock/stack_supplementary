...
# rfst - recurrence-free survival
# cens - censoring indicator
# htreat - hormonal therapy treatment indicator
# age - in years
# menostat - 1 = premenopause, 2 = post
# tumsize - tumor size in mm
# tumgrad - factor 1,2,3
...
X <- GBSG %>% select(hormon, age, meno, size, nodes,
                     pgr, er, tumgrad2, tumgrad3)
X <- sapply(X, as.numeric)
Y <- GBSG$rfstime
Delta <- as.numeric(GBSG$status)
