...
if (args$scheduler == "slurm"){
  source("/home/cwolock/stack_supplementary/sims/proportional_hazards/do_one.R")
  source("/home/cwolock/stack_supplementary/sims/generate_data.R")
} else if (args$scheduler == "sge"){
  source("/home/users/cwolock/stack_supplementary/sims/proportional_hazards/do_one.R")
