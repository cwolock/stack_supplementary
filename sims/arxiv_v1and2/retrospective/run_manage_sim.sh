...
if [[ ${4} == "slurm" ]]; then
  sbatch --array=1-$njobs -p short -t 3:00:00 -e ./iotrash/s-%A_%a.out -o ./iotrash/s-%A_%a.out /home/cwolock/stack_supplementary/sims/retrospective/call_manage_sim.sh $1 $2 $3 $4
else
