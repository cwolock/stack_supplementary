do_one <- function(sim_name, mc_id, n_train, estimator, dgp){
  ...
  # test data -should I generate this without truncation?
  ...
  # tuning parameters
  tune <- list(ntrees = c(200, 500), max_depth = c(1,2), minobspernode = 1, shrinkage = 0.1)
  ...
  fname <- paste0("output/", sim_name, "_", mc_id, ".rds")
