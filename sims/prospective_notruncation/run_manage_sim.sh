...
if [[ ${4} == "slurm"]]; then
  sbatch --array=1-$njobs -e ./iotrash/s-%A_%a.out -o ./iotrash/s-%A_%a.out -t 1-$njobs /home/cwolock/stack_supplementary/sims/prospective_notruncation/call_manage_sim.sh $1 $2 $3 $4
else
