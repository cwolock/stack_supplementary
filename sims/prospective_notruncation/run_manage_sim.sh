...
if [[ ${4} == "slurm" ]]; then
  sbatch --array=1-$njobs%300 -e ./iotrash/s-%A_%a.out -o ./iotrash/s-%A_%a.out /home/cwolock/stack_supplementary/sims/prospective_notruncation/call_manage_sim.sh $1 $2 $3 $4
else
