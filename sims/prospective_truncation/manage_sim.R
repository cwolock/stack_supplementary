...
parser$add_argument("--sim-name",
                    default = "prospective_truncation",
...
if (args$scheduler == "slurm"){
  source("/home/cwolock/stack_supplementary/sims/prospective_truncation/do_one.R")
  source("/home/cwolock/stack_supplementary/sims/generate_data.R")
} else if (args$scheduler == "sge"){
  source("/home/users/cwolock/stack_supplementary/sims/prospective_truncation/do_one.R")
